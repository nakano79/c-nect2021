...
<a href="<?php echo G5_URL ?>" class="register_logo"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
	    ...
	    <div class="form_01">
	        ...
	        <ul>
		        ...
		        <li>
		            ...
		            <span class="frm_info"><i class="fa fa-exclamation-circle"></i> 공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)<br>닉네임을 바꾸시면 앞으로 <?php echo (int)$config['cf_nick_modify'] ?>일 이내에는 변경 할 수 없습니다.</span>
		        </li>
		        <?php } ?>
